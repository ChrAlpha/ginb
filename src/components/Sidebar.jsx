...
const Sidebar = () => {
      ...
      <details className="z-40 flex flex-col gap-4 bg-white py-2.5 dark:bg-black md:hidden">
        <summary className="flex list-none flex-row">
          <svg
            ...
            viewBox="0 0 24 24"
            className="my-auto mr-1 h-6 w-6 fill-current"
          >
  ...
  return (
    <>
      ...
      {isSidebarOpen && (
        <div className="fixed right-0 top-12 z-40 flex h-full w-full flex-col gap-4 bg-white p-4 dark:bg-black md:hidden">
